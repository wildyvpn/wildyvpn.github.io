#!/bin/sh
YOUR_IPSEC_PSK=wildyvpn
YOUR_USERNAME=admin
YOUR_PASSWORD=admin

#JADI SAYANG CIUM DUHU MUAHHHH
...
if [ "$ipt_flag" = "1" ]; then
  ...
  echo "# Modified by WILDY VPN" > "$IPT_FILE"
...
BERIKUT AKUN L2TP MU JANGAN LUPA DI CATAT TUH..
...
ISSSS JADI SAYANG CIUM DULU DONG SINI SINI MUACH
